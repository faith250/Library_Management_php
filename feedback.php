        ...
        <div class="scroll">
            <?php
                if (isset($_POST['submit'])) {
                    ...
                    $sql = "INSERT INTO `comments` (username, comment) VALUES ('Admin', '" . mysqli_real_escape_string($db, $_POST['comment']) . "')";
                    if (mysqli_query($db, $sql)) {
                        // Fetch all comments after successful insertion
                    ...
                    // Fetch all comments if form not submitted
                    $q = "SELECT * FROM `comments` ORDER BY `comments`.`id` DESC"; 
                    $res = mysqli_query($db, $q);
